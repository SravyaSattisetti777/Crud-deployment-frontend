...
function EditStudent() {
    ...
    useEffect(() => {
        Axios.get("https://crud-deployment-backend-1f1p.onrender.com/studentRoute/update-student/" + id)
            .then((res) => {
                if (res.status === 200) {
    ...
    const handleSubmit = () => {
        ...
        Axios.put("https://crud-deployment-backend-1f1p.onrender.com/studentRoute/update-student/" + id, data)
            .then((res) => {
                if (res.status === 200)
